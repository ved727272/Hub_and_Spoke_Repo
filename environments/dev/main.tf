...
module "sql_server" {
  depends_on                   = [module.rg, module.keyvault, module.vnet, module.subnet, module.keyvault_secret]
...
module "virtual_machine" {
  depends_on = [ module.nic, module.subnet, module.keyvault, module.keyvault_secret]
  source = "../../Modules/azurerm_virtual_machine"
  vms = var.vms
}

module "load_balancer" {
  depends_on = [ module.rg, module.nic, module.virtual_machine]
...
module "log_analytics_workspace" {
  depends_on              = [module.rg]
  source                  = "../../Modules/azurerm_loganalytics"
  tags                    = local.common_tags
